...
public class UnitConstants {
	...
	// Beaver
	public static int BEAVER_ORE_COST = 100;
	
	// Miner
	public static int MINER_ORE_COST = 60;
	
	// Computer 
	public static int COMPUTER_ORE_COST = 10;
	
	// Soldier
	public static int SOLDIER_ORE_COST = 60;
	
	// Basher
	public static int BASHER_ORE_COST = 80; 
	
	// Drone
	public static int DRONE_ORE_COST = 125;
	
	// Tank
	public static int TANK_ORE_COST = 250;
	
	// Commander
	public static int FIRST_COMMANDER_ORE_COST = 100;
